...
<?php } ?>
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="complaintitem.php"><i class="menu-icon icon-tasks"></i>Add Complaint Item </a></li>
                                <li><a href="department.php"><i class="menu-icon icon-paste"></i>Add Department</a></li>
								<li><a href="location.php"><i class="menu-icon icon-paste"></i>Add Location</a></li>
								<li><a href="technician.php"><i class="menu-icon icon-group"></i>manage Stuff</a></li>

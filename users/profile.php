...
$depaertment=$_POST['department'];
$university=$_POST['university'];
$pincode=$_POST['pincode'];
$query=mysqli_query($con,"update users set fullName='$fname',contactNo='$contactno',designation='$designation',department='$department',university='$university',pincode='$pincode' where userEmail='".$_SESSION['login']."'");
if($query)
{
...
<div class="col-sm-4">
<textarea  name="designation" required="required" class="form-control"><?php echo htmlentities($row['designation']);?></textarea>
</div>
</div>
...
<div class="col-sm-4">
<input type="text" name="university" required="required" value="<?php echo htmlentities($row['university']);?>" class="form-control">
</div>
</div>

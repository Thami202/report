...
<html lang="en">
  <head>
    ...
    <title>RMS | Complaint Details</title>
...
<label class="col-sm-2 col-sm-2 control-label"><b>Complaint Item :</b> </label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['complaintitem']);?></p>
              </div>
            </div>
  ...
  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Location :</b></label>
              <div class="col-sm-4">
...
<label class="col-sm-2 col-sm-2 control-label"><b>Department :</b></label>
  ...
  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Room No :</b></label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['roomNo']);?></p>
              </div>
